...
get_komitet <- function(){
  ...
  for(i in comit_id) {
    ...
    write.table(results,
                paste0("data/members_komit_rada09_",  Sys.Date(),".csv"), 
...
membership_k <- read.csv("members_komit_rada09_2021-07-22.csv", header = FALSE, sep=";") %>% # Change a date according to a saved file
...
# Далі перейти у файл helper_scraper.R